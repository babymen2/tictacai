...
/*
        ...
        PercentPlayer o = new PercentPlayer(State.O);

        System.out.println(Arrays.toString(o.bestMove(b)));
		...
		//
		*/
        //simulateMinMaxvsRandom(500);
        simulatePercentvsRandom(2000);
    ...
    public static void simulatePercentvsRandom(int amount) {
        RandomPlayer pX = new RandomPlayer(State.X);
        PercentPlayer pO = new PercentPlayer(State.O);
